...
/// en el schema de Almacén: tabla <c>almacen.integration_events_outbox</c>
/// (F0-PR1).
///
/// <para>
/// Índice parcial sobre <c>(published_at)</c> filtrado por
/// <c>WHERE published_at IS NULL</c>: el worker lee solo filas no
/// publicadas, y Postgres mantiene el índice pequeño aunque la tabla
/// crezca a millones de filas históricas.
/// </para>
/// <para>
/// La tabla NO implementa <c>IPerteneceAEmpresa</c>: el worker debe poder
/// leer eventos de cualquier empresa sin filtro tenant. La columna
/// <c>integration_empresa_id</c> está denormalizada para que los
/// consumers la enruten.
/// </para>
/// </summary>
