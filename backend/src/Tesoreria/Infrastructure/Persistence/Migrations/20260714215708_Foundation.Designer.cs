...
namespace Millet.Tesoreria.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260714215708_Foundation")]
            ...
            modelBuilder.Entity("Millet.Tesoreria.Domain.Depositos.DepositoConfirmacion", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ConfirmadaEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("confirmada_en");

                    b.Property<Guid?>("ConfirmadaPor")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PropuestaCxcId")
                        .HasDatabaseName("ix_deposito_confirmacion_propuesta");
