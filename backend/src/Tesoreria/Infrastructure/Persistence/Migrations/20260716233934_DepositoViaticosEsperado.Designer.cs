...
namespace Millet.Tesoreria.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260716233934_DepositoViaticosEsperado")]
    partial class DepositoViaticosEsperado
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("deposito_confirmacion", "tesoreria", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_deposito_confirmacion_origen", "propuesta_cxc_id IS NOT NULL OR caja_sesion_id IS NOT NULL");
                        });
                });
